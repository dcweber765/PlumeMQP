...
def CO2Angle(fltCo20, fltCo21, fltCo22, fltCo23):
    # CO2 Interpolation
    D = 15.5                            # distance between sensors, inches
    c = 11.25
    B = math.pi/4
    ...
    if sortedvalues[i] == fltCo21:
        turnRight(32, 90)
        print "Case 2"

    if sortedvalues[i] == fltCo22:
        turnLeft(32, 90)
        print "Case 3"

    if sortedvalues[i] == fltCo23:
        turnLeft(32, 180)
        print "Case 4"
...
while(i < 5):
    ...
    resp3 = resp3[:8]
    fltCo23 = float(resp3[2:])
    goal = CO2Angle(fltCo20, fltCo21, fltCo22, fltCo23)
    print goal
